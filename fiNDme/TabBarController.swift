...
class TabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        self.tabBar.tintColor = UIColor(red:0.30, green:0.85, blue:0.39, alpha:1.0)
        //self.tabBar.barTintColor = UIColor(red:1.0, green:1.0, blue:1.0, alpha:1.0)
        self.tabBar.barTintColor = UIColor(red:0.94, green:0.94, blue:0.96, alpha:1.0)


        
        let names = ["284 Partners", "84.51", "Accenture", "Accion Chicago", "Advyzon", "Albourne Partners", "Bain & Company", "Booz Allen Hamilton", "Boston Consulting Group", "Capstone LLC", "CBS", "CDC", "Coca-Cola", "Dean & Company", "Deloitte", "Efficio", "Epic", "Ernst & Young", "Fiserv", "Glassdoor", "KPMG LLP", "Nike", "PepsiCo","PwC",]
        ...
        */
        ...
        for i in 0 ..< names.count {
            let companyToAdd = Company(name: names[i], industries: industries[i], about: about[i], jobs: jobs[i], contact: contacts[i], logo: logos[i], match: match[i])
