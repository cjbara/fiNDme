...
class TabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        let names = ["284 Partners", "84.51", "Accenture", "Accion Chicago", "Advyzon", "Albourne Partners", "Bain & Company", "Booz Allen Hamilton", "BCG", "Capstone LLC", "CBS", "CDC", "Coca-Cola", "Dean & Company", "Deloitte", "Efficio", "Epic", "Ernst & Young", "Fiserv", "Glassdoor", "KPMG LLP", "Nike", "PepsiCo","PwC",]
